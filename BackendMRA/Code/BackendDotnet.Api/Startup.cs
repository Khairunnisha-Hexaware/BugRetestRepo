using BackendDotnet.Api.Installer;
using BackendDotnet.Api.Middleware;
using BackendDotnet.Data.Repositories;
...
using System;
using BackendDotnet.Api.OpenTelemetry;
    ...
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "BackendDotnet V1");
        });
