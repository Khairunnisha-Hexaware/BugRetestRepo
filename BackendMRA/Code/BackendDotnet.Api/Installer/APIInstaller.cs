...
using BackendDotnet.Api.Filters;
using BackendDotnet.Business.Installer;

namespace BackendDotnet.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "BackendDotnet API", Version = version + "-" + branch });
        });
