...
{
    public class When_deleting_nanoscienceandtechnology : UsingNanoScienceAndTechnologyControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _nanoscienceandtechnologyService.Delete(Id).Returns(true);
        }
        ...
        {
            _nanoscienceandtechnologyService.Received(1).Delete(Id);
