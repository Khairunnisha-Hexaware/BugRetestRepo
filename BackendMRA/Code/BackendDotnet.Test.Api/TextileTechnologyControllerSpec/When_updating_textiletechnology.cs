...
{
    public class When_updating_textiletechnology : UsingTextileTechnologyControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _textiletechnologyService.Update(1, _textiletechnology).Returns(_textiletechnology);
        ...
        {
            _textiletechnologyService.Received(1).Update(1, _textiletechnology);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = resultListObject as TextileTechnology;
