...
{
    public class When_deleting_textiletechnology : UsingTextileTechnologyControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _textiletechnologyService.Delete(Id).Returns(true);
        }
        ...
        {
            _textiletechnologyService.Received(1).Delete(Id);
